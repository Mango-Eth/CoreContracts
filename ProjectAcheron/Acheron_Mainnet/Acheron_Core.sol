...
/// @author Built with love, by Skirk Labs
...
/// serve as enough accounting for share holders. If future governance protocols are released, this ERC721 will be
/// wrapped for an ERC20 amount of tokens, to further integrate with future projects. ~ John Smith

// SPDX-License-Identifier: BUSL.2 
pragma solidity ^0.8.20;

import "./Acheron_Compounder.sol";

contract Acheron_Core is Acheron_Compounder {
    ...
    /*
    * Must take in 300 - 900 xSkirk
    * .burn() said amount
    * swap dai into balanced amounts
    * aggregate
    */
    ...
    function cancelCL() public {
        require(msg.sender == SKIRK_AGGREGATOR);
        CANCEL = 0;
    }
